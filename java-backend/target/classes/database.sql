...
ALTER TABLE workflows ADD COLUMN IF NOT EXISTS error_code VARCHAR(10) COMMENT '错误码';
ALTER TABLE workflows ADD COLUMN IF NOT EXISTS rpo_ms BIGINT DEFAULT NULL COMMENT 'RPO延迟(毫秒)';
ALTER TABLE workflows ADD COLUMN IF NOT EXISTS rto_ms BIGINT DEFAULT NULL COMMENT 'RTO延迟(毫秒)';
ALTER TABLE workflows ADD COLUMN IF NOT EXISTS task_type VARCHAR(20) DEFAULT 'SYNC' COMMENT '任务类型: SYNC-同步, DR-灾备';
ALTER TABLE workflows ADD COLUMN IF NOT EXISTS dr_status VARCHAR(20) DEFAULT NULL COMMENT '灾备状态';
ALTER TABLE workflows ADD COLUMN IF NOT EXISTS dr_switch_count INT DEFAULT 0 COMMENT '灾备倒换次数';
