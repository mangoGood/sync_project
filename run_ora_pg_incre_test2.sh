...
RESP=$(curl -s -m 10 -X POST "$BASE/api/workflows" -H "Authorization: Bearer $TOKEN" -H "Content-Type: application/json" -d '{"name":"oracle-pg-inc2","sourceType":"oracle","targetType":"postgresql","taskType":"MIGRATION"}')
